...
public interface TableCacheMapper extends BaseMapper<TableCacheDO> {
    ...
    IPage<TableCacheDO> pageQuery(IPage<TableCacheDO> page, @Param("dataSourceId") Long dataSourceId, @Param("databaseName") String databaseName, @Param("schemaName") String schemaName,
