...
public interface DBManage {
     ...
     * @return
     */
    void dropTable(Connection connection, @NotEmpty String databaseName, @NotEmpty String schemaName, @NotEmpty String tableName);
    ...
    String exportTable(Connection connection, String databaseName, String schemaName, @NotEmpty String tableName) throws SQLException;

    void dropView(Connection connection, @NotEmpty String databaseName, String schemaName, @NotEmpty String viewName);
}
