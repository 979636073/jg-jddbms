...
import com.jd.common.tools.base.excption.SystemException;
import com.jd.common.tools.base.wrapper.result.ActionResult;
import com.jd.common.tools.common.exception.NeedLoggedInBusinessException;
import com.jd.common.tools.common.exception.RedirectBusinessException;
import com.jd.spi.util.ExceptionUtils;
import com.jd.web.exception.convertor.*;
...
public class EasyControllerExceptionHandler {
    ...
    static {
        ...
        EXCEPTION_CONVERTOR_MAP.put(ServiceException.class, new ServiceExceptionConvertor());
    }
    ...
    @ExceptionHandler({MethodArgumentNotValidException.class, BindException.class, IllegalArgumentException.class,
        ...
        NeedLoggedInBusinessException.class, ServiceException.class})
...
//        AjaxResult result = AjaxResult.error(ExceptionUtils.getMessage(exception));
    ...
    public ActionResult convert(Throwable exception) {
        ...
        if (exceptionConvertor == null) {
            if (exception instanceof BusinessException) {
                ...
                exceptionConvertor = EXCEPTION_CONVERTOR_MAP.get(ServiceException.class);
            } else {
