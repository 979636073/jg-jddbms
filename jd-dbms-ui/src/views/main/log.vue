  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="类型" prop="businessType">
        ...
        >
          <el-option
            v-for="dict in dict.type.log_enum"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
...
export default {
  name: "Operlog",
  dicts: ["log_enum", "sys_common_status"],
  data() {
    return {
      // 遮罩层
      loading: true,
