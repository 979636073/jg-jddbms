...
import com.jd.spi.model.Collation;

import java.util.Arrays;
import java.util.List;

public enum GbaseCollationEnum {
    ...
    GbaseCollationEnum(String collationName) {
    ...
    public static List<Collation> getCollations() {
        return Arrays.asList(GbaseCollationEnum.values()).stream().map(GbaseCollationEnum::getCollation).collect(java.util.stream.Collectors.toList());
    }
