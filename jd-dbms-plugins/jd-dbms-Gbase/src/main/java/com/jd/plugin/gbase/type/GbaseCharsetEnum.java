...
public enum GbaseCharsetEnum {
    ...
    GbaseCharsetEnum(String charsetName, String defaultCollationName) {
    ...
    public static List<Charset> getCharsets() {
        return Arrays.stream(GbaseCharsetEnum.values()).map(GbaseCharsetEnum::getCharset).collect(java.util.stream.Collectors.toList());
    }
