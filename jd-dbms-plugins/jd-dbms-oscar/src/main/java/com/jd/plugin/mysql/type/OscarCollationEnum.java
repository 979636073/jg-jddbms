...
public enum OscarCollationEnum {
    ...
    OscarCollationEnum(String collationName) {
    ...
    public static List<Collation> getCollations() {
        return Arrays.asList(OscarCollationEnum.values()).stream().map(OscarCollationEnum::getCollation).collect(java.util.stream.Collectors.toList());
    }
