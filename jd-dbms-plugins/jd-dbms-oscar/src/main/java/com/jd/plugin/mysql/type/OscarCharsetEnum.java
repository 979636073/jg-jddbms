...
import com.jd.spi.model.Charset;

import java.util.Arrays;
import java.util.List;

public enum OscarCharsetEnum {
    ...
    OscarCharsetEnum(String charsetName, String defaultCollationName) {
    ...
    public static List<Charset> getCharsets() {
        return Arrays.stream(OscarCharsetEnum.values()).map(OscarCharsetEnum::getCharset).collect(java.util.stream.Collectors.toList());
    }
