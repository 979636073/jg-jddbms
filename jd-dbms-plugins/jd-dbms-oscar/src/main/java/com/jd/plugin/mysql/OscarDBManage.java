...
public class OscarDBManage extends DefaultDBManage implements DBManage {
    @Override
    public void connectDatabase(Connection connection, String database) {
        ...
        if (ObjectUtils.anyNull(connectInfo) || org.apache.commons.lang3.StringUtils.isEmpty(connectInfo.getSchemaName())) {
            return;
        }
        try {
